...
// INDEP RHS Insurgents
if (_faction == 5) then
{
	_InfPool   =	["rhs_g_Soldier_AA_F", "rhs_g_Soldier_exp_F", "rhs_g_engineer_F", "rhs_g_Soldier_LAT_F", "rhs_g_Soldier_AAT_F", "rhs_g_Soldier_AR_F", "rhs_g_Soldier_AAR_F", "rhs_g_Soldier_M_F", "rhs_g_medic_F", "rhs_g_Soldier_F2", "rhs_g_Soldier_F3", "rhs_g_Soldier_F"];
	_ArmPool   =	["rhs_t72bb_chdkz", "rhs_bmd1_chdkz", "rhs_bmd2_chdkz", "rhs_bmp1_chdkz", "rhs_bmp1d_chdkz", "rhs_bmp1k_chdkz", "rhs_bmp1p_chdkz", "rhs_bmp2_chdkz", "rhs_bmp2e_chdkz", "rhs_bmp2d_chdkz", "rhs_bmp2k_chdkz", "rhs_zsu234_chdkz", "RHS_BM21_chdkz"];
	_MotPool   =	["RHS_UAZ_chdkz", "rhs_uaz_ags_chdkz", "rhs_uaz_dshkm_chdkz", "rhs_uaz_open_chdkz", "rhs_uaz_spg9_chdkz", "rhs_ural_chdkz", "rhs_ural_open_chdkz", "rhs_ural_work_open_chdkz", "rhs_ural_work_chdkz", "rhs_btr60_chdkz", "rhs_btr70_chdkz"];
	_ACHPool   =	[];
	_CHPool    =	["RHS_Mi8amt_chdkz"];
	_uavPool   =	[];
	_stPool    =	["rhs_Metis_9k115_1_ins", "rhs_Metis_9k115_2_ins", "rhs_Igla_AA_pod_ins", "RHS_AGS30_TriPod_INS", "rhs_DSHKM_ins", "rhs_DSHKM_Mini_TriPod_ins", "rhs_KORD_INS", "rhs_KORD_high_INS", "HS_NSV_TriPod_INS", "rhs_SPG9_INS"];
	_shipPool  =	[];
	_diverPool =	["rhs_g_Crew_F"];
	_crewPool  =	["rhs_g_Crew_F"];
	_heliCrew  =	["rhs_g_Crew_F"];
};
